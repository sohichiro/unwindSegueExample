...
//  unwindSegueExample
//
//  Created by 長尾聡一郎 on 2018/05/14.
...
class RedViewController: UIViewController {
    ...
    @IBAction func pushToCream(_ sender: Any) {
        let storyBoard = UIStoryboard(name: "Main", bundle: nil)
        let creamVC = storyBoard.instantiateViewController(withIdentifier: "CreamViewController")
        self.navigationController?.pushViewController(creamVC, animated: true)
    }
